            ...
            <div className="categories__wrapper">
                <div className="categories__left">
                    <div className="categories__left--top">  
                        <Link to={`/`} className="content__left">Bags</Link>
                    </div>
                    <div className="categories__left--bottom">    
                        <Link to={`/`} className="content__left">Tees</Link>                    
                    </div>
                </div>
                <div className="categories__middle">
                    ...
                    <div className="content__middle">
                        <Link to={`/`} className="content__middle--link">Pop Culture</Link>
                    </div>
                </div>
                <div className="categories__right">
                    <div className="categories__right--top">
                        <Link to={`/`} className="content__right">Band Merch</Link>
                    </div>
                    <div className="categories__right--bottom">
                        <Link to={`/`} className="content__right">Hats</Link>
                    </div>
                </div>
            </div>
        </section>
